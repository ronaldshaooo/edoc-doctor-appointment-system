                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>謝謝您使用本系統<br>
                            您可以瀏覽每日的規劃, 在家就能瀏覽預約清單!<br><br>
                            </p>
                            <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">瀏覽預約清單</button></a>
                            <br>
                            <br>
                        </td>
                    </tr>
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;">您未來的看診時段</p>
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">我們找不到關鍵字結果 !</p>
